...
int main(int argc, char* argv[]) {
	...
	//to jest wskaźnik na Pracownika
	Pracownik* p3;	//TODO: sprawdz dlaczego kompilator nie puszcza tego kodu. Replit przepuszcza bez problemu
	//przy wskaźniku  zamiast kropek są strzałki
	p3->wpisz();
	p3->wyswietl();
}