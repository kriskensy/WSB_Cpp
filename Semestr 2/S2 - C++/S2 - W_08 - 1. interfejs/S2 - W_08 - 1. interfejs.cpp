...
//IDokumentZWydrukiem jest interfejsem ponieważ zawiera wyłącznie metody czysto wirtualne (abstrakcyjne)
class IdokumentZWydrukiem
{
    public:
        virtual void wyswietl() = 0;
};

class Umowa : public IdokumentZWydrukiem
{
    public:
