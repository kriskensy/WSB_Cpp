...
//Ta sama aplikacja tylko z funkcjami wirtualnymi, bez powtarzalności kodu.
...
//funkcja obliczPodatek() jest wirtualna dllatego, że funkcja wyswietl(), która jest niżej działa raz dla Umowa innym razem dla UmowaZlecenie a innym razem dla UmowaAutorska
//jeżeli funkcja obliczPodatek jest wirtualna to funkcja wyswietl() wywoła się z tej klasy, której reprezentuje obiekt (dla Umowa z Umowa, dla UmowaZlecenie z UmowaZlecenie i dla UmowaAutorska z UmowaAutorska)
//gdyby nie była wirtualna to funkcja wyświetl wywołałaby ją zawsze z Umowa czyli dla Umowa z Umowa, dla UmowaZlecenie też z Umowa i dla UmowaAutorska też z Umowa
//virtual powoduje wywołanie funkcji z odpowiednich klas
